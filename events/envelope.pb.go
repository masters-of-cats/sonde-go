...
const (
	...
	Envelope_ContainerCPUUsage Envelope_EventType = 10
)
...
type Envelope struct {
	...
	ContainerCPUUsage *ContainerCPUUsage `protobuf:"bytes,18,opt,name=containerCPUUsage" json:"containerCPUUsage,omitempty"`
...
func (m *Envelope) GetContainerCPUUsage() *ContainerCPUUsage {
	if m != nil {
		return m.ContainerCPUUsage
	}
	return nil
}
...
func (m *Envelope) MarshalTo(data []byte) (int, error) {
	...
	if m.ContainerCPUUsage != nil {
		data[i] = 0x92
		i++
		data[i] = 0x1
		i++
		i = encodeVarintEnvelope(data, i, uint64(m.ContainerCPUUsage.Size()))
		n7, err := m.ContainerCPUUsage.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n7
...
func (m *Envelope) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 18:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ContainerCPUUsage", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ContainerCPUUsage == nil {
				m.ContainerCPUUsage = &ContainerCPUUsage{}
			}
			if err := m.ContainerCPUUsage.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorEnvelope = []byte{
	...
	,
}
