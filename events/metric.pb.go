...
// / A ContainerCPUUsage records the CPU usage of an app in a container against its CPU entitlement
type ContainerCPUUsage struct {
	ApplicationId       *string `protobuf:"bytes,1,req,name=applicationId" json:"applicationId,omitempty"`
	InstanceIndex       *int32  `protobuf:"varint,2,req,name=instanceIndex" json:"instanceIndex,omitempty"`
	AbsoluteUsage       *uint64 `protobuf:"varint,3,req,name=absoluteUsage" json:"absoluteUsage,omitempty"`
	AbsoluteEntitlement *uint64 `protobuf:"varint,4,req,name=absoluteEntitlement" json:"absoluteEntitlement,omitempty"`
	ContainerAge        *uint64 `protobuf:"varint,5,req,name=containerAge" json:"containerAge,omitempty"`
	XXX_unrecognized    []byte  `json:"-"`
}

func (m *ContainerCPUUsage) Reset()                    { *m = ContainerCPUUsage{} }
func (m *ContainerCPUUsage) String() string            { return proto.CompactTextString(m) }
func (*ContainerCPUUsage) ProtoMessage()               {}
func (*ContainerCPUUsage) Descriptor() ([]byte, []int) { return fileDescriptorMetric, []int{3} }

func (m *ContainerCPUUsage) GetApplicationId() string {
	if m != nil && m.ApplicationId != nil {
		return *m.ApplicationId
	}
	return ""
...
func (m *ContainerCPUUsage) GetInstanceIndex() int32 {
	if m != nil && m.InstanceIndex != nil {
		return *m.InstanceIndex
	}
	return 0
...
func (m *ContainerCPUUsage) GetAbsoluteUsage() uint64 {
	if m != nil && m.AbsoluteUsage != nil {
		return *m.AbsoluteUsage
	}
	return 0
}

func (m *ContainerCPUUsage) GetAbsoluteEntitlement() uint64 {
	if m != nil && m.AbsoluteEntitlement != nil {
		return *m.AbsoluteEntitlement
	}
	return 0
}

func (m *ContainerCPUUsage) GetContainerAge() uint64 {
...
func init() {
	...
	proto.RegisterType((*ContainerCPUUsage)(nil), "events.ContainerCPUUsage")
}
...
func (m *ContainerCPUUsage) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *ContainerCPUUsage) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.AbsoluteUsage == nil {
		return 0, github_com_gogo_protobuf_proto.NewRequiredNotSetError("absoluteUsage")
	} else {
		data[i] = 0x18
		i++
		i = encodeVarintMetric(data, i, uint64(*m.AbsoluteUsage))
	}
	if m.AbsoluteEntitlement == nil {
		return 0, github_com_gogo_protobuf_proto.NewRequiredNotSetError("absoluteEntitlement")
	} else {
		data[i] = 0x20
		i++
		i = encodeVarintMetric(data, i, uint64(*m.AbsoluteEntitlement))
	}
...
func (m *ContainerCPUUsage) Size() (n int) {
	var l int
	_ = l
	if m.ApplicationId != nil {
		l = len(*m.ApplicationId)
	...
	if m.AbsoluteUsage != nil {
		n += 1 + sovMetric(uint64(*m.AbsoluteUsage))
	}
	if m.AbsoluteEntitlement != nil {
		n += 1 + sovMetric(uint64(*m.AbsoluteEntitlement))
	}
	if m.ContainerAge != nil {
...
func (m *ContainerCPUUsage) Unmarshal(data []byte) error {
	var hasFields [1]uint64
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ContainerCPUUsage: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ContainerCPUUsage: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AbsoluteUsage", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AbsoluteEntitlement", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
	...
	if hasFields[0]&uint64(0x00000004) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("absoluteUsage")
	}
	if hasFields[0]&uint64(0x00000008) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("absoluteEntitlement")
	}
	if hasFields[0]&uint64(0x00000010) == 0 {
...
var fileDescriptorMetric = []byte{
	...
	,
}
